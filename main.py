...
import sys
from routes import auth, biteship, bulk_algorithm, items, marketplace, statistics, xendit, admin_settings, centra_finance, centra_setting, courier, wet_leaves, dry_leaves, flour, location, market_shipment, products, roles, shipment, subTransaction, transaction, users
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8000", "http://localhost:5004", "https://leafty.csbihub.id", "https://leafty-rest-api.csbihub.id"],
