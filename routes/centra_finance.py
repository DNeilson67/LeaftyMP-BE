...
@router.post("/centra_finance/post", response_model=schemas.CentraFinance, tags=["Centra Finance"])
def create_centra_finance(centra_finance: schemas.CentraFinanceCreate, db: Session = Depends(get_db)):
    return crud.create_centra_finance(db=db, centra_finance=centra_finance)

@router.get("/centra_finances/get", response_model=List[schemas.CentraFinance], tags=["Centra Finance"])
...
@router.get("/centra_finance/get/{finance_id}", response_model=schemas.CentraFinance, tags=["Centra Finance"])
...
@router.put("/centra_finance/put/{finance_id}", response_model=schemas.CentraFinance, tags=["Centra Finance"])
def update_centra_finance(finance_id: int, centra_finance_update: schemas.CentraFinanceBase, db: Session = Depends(get_db)):
...
@router.get("/centra_finance/get_user/{user_id}", response_model=schemas.CentraFinance, tags=["Centra Finance"])
