...
@router.post("/centra_setting_detail/post", response_model=schemas.CentraSettingDetail, tags=["Centra Setting Detail"])
...
@router.get("/centra_setting_details/get", response_model=List[schemas.CentraSettingDetail], tags=["Centra Setting Detail"])
...
@router.get("/centra_setting_detail/get/{setting_detail_id}", response_model=schemas.CentraSettingDetail, tags=["Centra Setting Detail"])
...
@router.get("/centra_setting_detail/get_user/{user_id}", response_model=List[schemas.CentraSettingDetail], tags=["Centra Setting Detail"])
...
@router.get("/centra_setting_detail/get_user/{user_id}/{item_name}", response_model=List[Dict], tags=["Centra Setting Detail"])
...
@router.put("/centra_setting_detail/put/{setting_detail_id}", response_model=schemas.CentraSettingDetail, tags=["Centra Setting Detail"])
...
@router.delete("/centra_setting_detail/delete/{setting_detail_id}", response_class=JSONResponse, tags=["Centra Setting Detail"])
...
@router.patch("/centra_settings_detail/patch/{setting_detail_id}", response_model=str, tags=["Centra Setting Detail"])
...
@router.post("/centra_base_settings/post", response_model=schemas.CentraBaseSettings, tags=["Centra Base Settings"])
...
@router.get("/centra_base_settings/get", response_model=List[schemas.CentraBaseSettings], tags=["Centra Base Settings"])
...
@router.put("/centra_base_settings/put/{settings_id}", response_model=schemas.CentraBaseSettings, tags=["Centra Base Settings"])
...
@router.patch("/centra_base_settings/patch/{UserID}/{ProductID}", response_model=List[Dict], tags=["Centra Base Settings"])
...
@router.delete("/centra_base_settings/delete/{settings_id}", response_class=JSONResponse, tags=["Centra Base Settings"])
...
@router.get("/centra_base_settings/get_user/{user_id}/{item_name}", response_model=List[Dict], tags=["Centra Base Settings"])
