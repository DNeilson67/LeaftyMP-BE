...
@router.post("/wetLeaves/post", response_model=schemas.WetLeaves, tags=["WetLeaves"])
...
@router.get("/wetleaves/get", tags=["WetLeaves"])
def get_wet_leaves_for_admin(db: Session = Depends(get_db)):
    return crud.get_wet_leaves(db=db)

@router.get("/wetleaves/get/{wet_leaves_id}", response_model=schemas.WetLeaves, tags=["WetLeaves"])
...
@router.get("/wetleaves/get_by_user/{user_id}", response_model=List[schemas.WetLeaves], tags=["WetLeaves"])
...
@router.get('/wetleaves/sum_weight_today/{user_id}', tags=["WetLeaves"])
...
@router.delete("/wetleaves/delete/{wet_leaves_id}", response_class=JSONResponse, tags=["WetLeaves"])
...
@router.put("/wetleaves/put/{wet_leaves_id}", response_model=schemas.WetLeaves, tags=["WetLeaves"])
...
@router.put("/wetleaves/update_status/{wet_leaves_id}", response_model=schemas.WetLeaves, tags=["WetLeaves"])
