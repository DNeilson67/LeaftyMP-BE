...
@router.post("/wetLeaves/post", response_model=schemas.WetLeaves)
...
@router.get("/wetleaves/get/{wet_leaves_id}", response_model=schemas.WetLeaves)
...
@router.get("/wetleaves/get_by_user/{user_id}", response_model=List[schemas.WetLeaves])
...
@router.put("/wetleaves/put/{wet_leaves_id}", response_model=schemas.WetLeaves)
...
@router.put("/wetleaves/update_status/{wet_leaves_id}", response_model=schemas.WetLeaves)
